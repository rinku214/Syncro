...
<section class="p-faq" id="faq">
    <div class="p-faq__inner inner">
        ...
        <h1 class="p-faq__title c-section__title">よくあるご質問</h1>

        <div class="p-faq__items">

            <div class="p-faq__item">
                <div class="p-faq__item-Q">初めてでもうまく使えますか？</div>
                <div class="p-faq__item-A">はいSyncroでは初めてでも全ての機能を使えるよう、UIに改善を重ねていますので、問題なくご利用いただけます。</div>
            </div>

            <div class="p-faq__item">
                <div class="p-faq__item-Q">カレンダーは何人まで閲覧可能ですか？</div>
                <div class="p-faq__item-A">プランによって異なりますが、Proプラン以上の場合は無制限で閲覧・編集可能です。</div>
            </div>

            <div class="p-faq__item">
                <div class="p-faq__item-Q">AIアシスタントはどのようなことができますか？</div>
                <div class="p-faq__item-A">AIアシスタントは、ユーザーの入力に基づいて自動的に応答を生成し、タスクの管理や予定の調整など、さまざまなサポートを提供します。</div>
            </div>

            <div class="p-faq__item">
                <div class="p-faq__item-Q">ダッシュボードの色などは変えられますか？</div>
                <div class="p-faq__item-A">はい、ダッシュボードの色やデザインはユーザーの好みに合わせてカスタマイズできます。</div>
            </div>

            <div class="p-faq__item">
                <div class="p-faq__item-Q">学生割引などはありますか？</div>
                <div class="p-faq__item-A">はい、学生の方には特別割引が適用されます。詳細はお問い合わせください。</div>
            </div>
